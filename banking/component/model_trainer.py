...
from banking.entity.model_factory import evaluate_classification_model
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            banking_model = BankingEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
